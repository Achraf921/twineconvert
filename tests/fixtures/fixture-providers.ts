...
export const FIXTURE_PROVIDERS: Record<string, FixtureSpec> = {
  ...
  "bibtex-to-apa-html":        { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-mla-html":        { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-chicago-html":    { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-harvard-html":    { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "ris-to-apa-html":           { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-mla-html":           { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-chicago-html":       { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-harvard-html":       { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "csl-json-to-apa-html":      { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "csl-json-to-mla-html":      { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "csl-json-to-chicago-html":  { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "csl-json-to-harvard-html":  { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "bibtex-to-ieee-html":         { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-vancouver-html":    { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-ama-html":          { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "ris-to-ieee-html":            { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-vancouver-html":       { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-ama-html":             { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "csl-json-to-ieee-html":       { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "csl-json-to-vancouver-html":  { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "csl-json-to-ama-html":        { provider: () => text("refs.json", F.cslJson, "application/json"), env: "node" },
  "bibtex-to-nature-html":     { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-acs-html":        { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "bibtex-to-asa-html":        { provider: () => text("refs.bib", F.bibtex, "application/x-bibtex"), env: "node" },
  "ris-to-nature-html":        { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-acs-html":           { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
  "ris-to-asa-html":           { provider: () => text("refs.ris", F.ris, "application/x-research-info-systems"), env: "node" },
