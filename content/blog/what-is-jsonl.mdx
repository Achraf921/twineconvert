...
The community has not converged on one name. The format spec at [jsonlines.org](https://jsonlines.org/) uses "JSON Lines." Most tools accept any of the above as input.
