...
/**
 * BibTeX → Chicago in-text citations. Parses BibTeX into the unified Citation
 ...
 */
const bibtexToChicagoIntext: Converter = {
  id: "bibtex-to-chicago-intext",
  label: "BibTeX → Chicago In-Text Citations",
...
export default bibtexToChicagoIntext;
