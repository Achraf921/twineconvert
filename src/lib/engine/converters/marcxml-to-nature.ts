...
/**
 * MARCXML → Nature. Parses a MARCXML export into the unified Citation
 ...
 */
const marcxmlToNature: Converter = {
  id: "marcxml-to-nature",
  ...
  async convert(input, opts) {
    ...
    try {
      ...
      throw new ConvertFailedError(
        err instanceof Error ? err.message : "Could not convert MARCXML to Nature",
        err,
      );
    }
    opts?.onProgress?.(1);
...
export default marcxmlToNature;
