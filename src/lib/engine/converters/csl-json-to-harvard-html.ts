...
/**
 * CSL-JSON -> Harvard (HTML). Parses CSL-JSON into the unified Citation model, then
 ...
 */
const cslJsonToHarvardHtml: Converter = {
  id: "csl-json-to-harvard-html",
  label: "CSL-JSON -> Harvard (HTML)",
...
export default cslJsonToHarvardHtml;
