...
/**
 * RIS -> Harvard (HTML). Parses RIS into the unified Citation model, then
 ...
 */
const risToHarvardHtml: Converter = {
  id: "ris-to-harvard-html",
  label: "RIS -> Harvard (HTML)",
...
export default risToHarvardHtml;
