...
/**
 * BibTeX -> IEEE (HTML). Parses BibTeX into the unified Citation model, then
 ...
 */
const bibtexToIeeeHtml: Converter = {
  id: "bibtex-to-ieee-html",
...
export default bibtexToIeeeHtml;
