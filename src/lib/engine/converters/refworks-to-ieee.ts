...
/**
 * RefWorks → IEEE. Parses a RefWorks export into the unified Citation
 ...
 */
const refworksToIeee: Converter = {
  id: "refworks-to-ieee",
  label: "RefWorks → IEEE",
  ...
  async convert(input, opts) {
    ...
    try {
      ...
      throw new ConvertFailedError(
        err instanceof Error ? err.message : "Could not convert RefWorks to IEEE",
        err,
      );
    }
    opts?.onProgress?.(1);
