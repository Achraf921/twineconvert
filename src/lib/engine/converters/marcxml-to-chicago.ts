...
/**
 * MARCXML → Chicago. Parses a MARCXML export into the unified Citation
 ...
 */
const marcxmlToChicago: Converter = {
  id: "marcxml-to-chicago",
  ...
  async convert(input, opts) {
    ...
    try {
      ...
      throw new ConvertFailedError(
        err instanceof Error ? err.message : "Could not convert MARCXML to Chicago",
        err,
      );
    }
    opts?.onProgress?.(1);
...
export default marcxmlToChicago;
