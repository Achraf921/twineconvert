...
/**
 * BibTeX → APA in-text citations. Parses BibTeX into the unified Citation
 ...
 */
const bibtexToApaIntext: Converter = {
  id: "bibtex-to-apa-intext",
  label: "BibTeX → APA In-Text Citations",
...
export default bibtexToApaIntext;
