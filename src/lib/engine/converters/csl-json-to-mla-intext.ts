...
/**
 * CSL-JSON → MLA in-text citations. Parses CSL-JSON into the unified Citation
 ...
 */
const cslJsonToMlaIntext: Converter = {
  id: "csl-json-to-mla-intext",
  label: "CSL-JSON → MLA In-Text Citations",
...
export default cslJsonToMlaIntext;
