...
/**
 * Web of Science → Harvard. Parses a Web of Science export into the unified Citation
  ...
  async convert(input, opts) {
    ...
    try {
      ...
      throw new ConvertFailedError(
        err instanceof Error ? err.message : "Could not convert Web of Science to Harvard",
        err,
      );
    }
    opts?.onProgress?.(1);
