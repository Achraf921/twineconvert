...
/**
 * CSL-JSON → Harvard in-text citations. Parses CSL-JSON into the unified Citation
 ...
 */
const cslJsonToHarvardIntext: Converter = {
  id: "csl-json-to-harvard-intext",
  label: "CSL-JSON → Harvard In-Text Citations",
...
export default cslJsonToHarvardIntext;
