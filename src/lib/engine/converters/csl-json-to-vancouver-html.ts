...
/**
 * CSL-JSON -> Vancouver (HTML). Parses CSL-JSON into the unified Citation model, then
 ...
 */
const cslJsonToVancouverHtml: Converter = {
  id: "csl-json-to-vancouver-html",
...
export default cslJsonToVancouverHtml;
