...
/**
 * BibTeX -> Vancouver (HTML). Parses BibTeX into the unified Citation model, then
 ...
 */
const bibtexToVancouverHtml: Converter = {
  id: "bibtex-to-vancouver-html",
...
export default bibtexToVancouverHtml;
