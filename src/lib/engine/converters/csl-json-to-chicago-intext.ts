...
/**
 * CSL-JSON → Chicago in-text citations. Parses CSL-JSON into the unified Citation
 ...
 */
const cslJsonToChicagoIntext: Converter = {
  id: "csl-json-to-chicago-intext",
  label: "CSL-JSON → Chicago In-Text Citations",
...
export default cslJsonToChicagoIntext;
