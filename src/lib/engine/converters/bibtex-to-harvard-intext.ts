...
/**
 * BibTeX → Harvard in-text citations. Parses BibTeX into the unified Citation
 ...
 */
const bibtexToHarvardIntext: Converter = {
  id: "bibtex-to-harvard-intext",
  label: "BibTeX → Harvard In-Text Citations",
...
export default bibtexToHarvardIntext;
