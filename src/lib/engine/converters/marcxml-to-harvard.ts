...
/**
 * MARCXML → Harvard. Parses a MARCXML export into the unified Citation
 ...
 */
const marcxmlToHarvard: Converter = {
  id: "marcxml-to-harvard",
  ...
  async convert(input, opts) {
    ...
    try {
      ...
      throw new ConvertFailedError(
        err instanceof Error ? err.message : "Could not convert MARCXML to Harvard",
        err,
      );
    }
    opts?.onProgress?.(1);
...
export default marcxmlToHarvard;
