...
/**
 * CSL-JSON -> ACS (HTML). Parses CSL-JSON into the unified Citation model, then
 ...
 */
const cslJsonToAcsHtml: Converter = {
  id: "csl-json-to-acs-html",
  label: "CSL-JSON -> ACS (HTML)",
...
export default cslJsonToAcsHtml;
